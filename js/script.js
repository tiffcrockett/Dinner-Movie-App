    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (totalresults > 0) {
                ...
                $('#food-1').append('<h5 style="padding-left:35px;color:#ad1457;font-weight:bold;">Here are our dinner suggestions:</h5>');
...
var foodChoices = {
    ...
    //Drama
    18: ["soul food", "comfortfood", "seafood"],
    //Family
